...
import { FolderOpen, ArrowRight, Upload } from "lucide-react"
          ...
          <div className="relative flex flex-col items-start gap-8 md:flex-row md:items-center md:justify-between">
            <div className="max-w-xl">
              ...
              <h2 className="mt-5 text-balance text-2xl font-semibold tracking-tight text-foreground sm:text-3xl">
                {t.assistant?.homeTitle ?? t.opener.title}
              </h2>
              <p className="mt-3 text-pretty leading-relaxed text-muted-foreground">
                {t.assistant?.homeSubtitle ?? t.opener.subtitle}
              </p>
              <Link
                href={href("/otworz")}
              ...
              >
                ...
                {t.assistant?.homeCta ?? t.opener.cta}
