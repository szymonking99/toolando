/**
 * One-off generator for extra-locales.ts — run: node lib/i18n/utility-meta/generate-extra-locales.mjs
 */
...
const CAT_KEYS = ["finance", "time", "units", "text", "dev", "media"];
...
console.log("French and Italian registered. Run full script for all locales.");
