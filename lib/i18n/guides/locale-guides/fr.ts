...
export const guidesFr: Record<GuideSlug, GuideArticle> = {
  ...
  "toolando-editorial-standards": {
    ...
    sections: [
      {
        paragraphs: [
          "Toolando.tech est développé seul par Szymon. Les guides ne sont ni générés en masse ni copiés de Wikipédia — ils reposent sur de vrais tests de conversion.",
