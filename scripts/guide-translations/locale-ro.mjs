export default {
  "mp3-vs-wav": {
    ...
    description:
      "MP3 vs WAV comparate: compresie cu pierderi vs fără pierderi, dimensiune fișier, editare în DAW și ce format alegi.",
    sections: [
      {
        paragraphs: [
  ...
  "pdf-to-jpg": {
    ...
    description:
      "Când exportezi pagini PDF ca JPG, ce rezoluție folosești și când e mai bun PNG.",
    sections: [
      {
        paragraphs: [
  ...
  "webp-avif-images": {
    ...
    description:
      "WebP și AVIF vs JPG/PNG: compresie, suport browser și optimizare PageSpeed.",
    sections: [
      {
        paragraphs: [
  ...
  "extract-audio-from-video": {
    ...
    description:
      "Cum extragi legal o pistă audio din propriul fișier video (MP4, MOV, MKV).",
    sections: [
      {
        paragraphs: [
  ...
  "json-csv-xml": {
    ...
    description:
      "Când folosești JSON, CSV, TSV și XML și cum convertești între ele fără a pierde structura.",
    sections: [
      {
        paragraphs: [
  ...
  "online-file-security": {
    ...
    description:
      "Cum procesează Toolando.tech fișierele, când instrumentele rulează local în browser și detalii despre confidențialitate.",
    sections: [
      {
        paragraphs: [
  ...
  "lossy-vs-lossless": {
    ...
    description:
      "Cum diferă compresia cu și fără pierderi și cum eviți pierderea calității la conversie.",
    sections: [
      {
        paragraphs: [
  ...
  "heic-iphone-jpg": {
    ...
    description:
      "De ce iPhone salvează HEIC, probleme de compatibilitate și cum convertești în JPG sau PNG.",
    sections: [
      {
        paragraphs: [
  ...
  "pdf-vs-docx": {
    ...
    description:
      "Diferențe PDF vs DOCX: editare, tipar, arhivare și când convertești în ce direcție.",
    sections: [
      {
        paragraphs: [
  ...
  "video-social-media": {
    ...
    description:
      "Cum pregătești video pentru Instagram, TikTok, YouTube: format MP4, H.264, rezoluție 1080p.",
    sections: [
      {
        paragraphs: [
  ...
  "choose-audio-bitrate": {
    ...
    description:
      "128 vs 192 vs 320 kbps — alegeri practice pentru podcasturi, muzică și video fără a irosi spațiu pe disc.",
    sections: [
      {
        paragraphs: [
  ...
  "prepare-images-for-web": {
    ...
    description:
      "Rezoluție, compresie și format — accelerează site-ul fără pierdere vizibilă de calitate.",
    sections: [
      {
        paragraphs: [
  ...
  "docx-pdf-workflow": {
    ...
    description:
      "Trimiterea CV-urilor, facturilor și contractelor: de ce PDF bate DOCX și cum eviți fonturile stricate.",
    sections: [
      {
        paragraphs: [
  ...
  "compress-images-without-quality-loss": {
    ...
    description:
      "Când folosești compresorul, ce nivel de calitate alegi și compresie vs conversie de format.",
    sections: [
      {
        paragraphs: [
  ...
  "merge-pdf-online-guide": {
    ...
    description:
      "Combinarea facturilor, scanărilor și atașamentelor — ordinea paginilor, calitate și confidențialitate.",
    sections: [
      {
        paragraphs: [
  ...
  "spreadsheet-csv-json-guide": {
    ...
    description:
      "Când alegi CSV vs JSON și cum eviți zecimale și codare stricate.",
    sections: [
      {
        paragraphs: [
  ...
  "video-compress-before-sharing": {
    ...
    description:
      "MP4, rezoluție, bitrate — limite practice de dimensiune și conversie de container.",
    sections: [
      {
        paragraphs: [
  ...
  "font-woff2-for-websites": {
    ...
    description:
      "Conversia fonturilor pentru @font-face, licențe și impact asupra vitezei paginii.",
    sections: [
      {
        paragraphs: [
  ...
  "toolando-editorial-standards": {
    ...
    description:
      "Cum sunt produse articolele, testele convertorilor și enciclopedia formatelor — transparență pentru cititori și recenzori.",
    sections: [
      {
        paragraphs: [
  ...
  "when-not-to-convert-files": {
    ...
    description:
      "Evită conversiile inutile: păstrează originalele, arhive fără pierderi și backup înainte de experimente.",
    sections: [
      {
        paragraphs: [
  ...
  "png-vs-jpg-photos-and-graphics": {
    ...
    description:
      "Alegeri practice: fotografii, capturi de ecran, logo-uri cu transparență și tipar.",
    sections: [
      {
        paragraphs: [
  ...
  "flac-music-archive-guide": {
    ...
    description:
      "FLAC fără pierderi vs MP3 320 kbps: backup-uri, streaming acasă și playere auto.",
    sections: [
      {
        paragraphs: [
  ...
  "zip-7z-rar-when-to-use": {
    ...
    description:
      "Dimensiune, compatibilitate și criptare — când ZIP e suficient și când ajută 7z sau RAR.",
    sections: [
      {
        paragraphs: [
  ...
  "svg-vs-png-logos-and-icons": {
    ...
    description:
      "Vector vs raster: când livrezi SVG și când e suficient PNG @2x.",
    sections: [
      {
        paragraphs: [
  ...
  "podcast-export-mp3-aac-settings": {
    ...
    description:
      "Setări după înregistrare în Audacity, Reaper sau pe telefon: mono, 44,1 kHz, compresie rezonabilă.",
    sections: [
      {
        paragraphs: [
  ...
  "gif-vs-mp4-for-animations": {
    ...
    description:
      "Când GIF-ul clasic are sens și când un MP4 sau WebM scurt economisește megabytes.",
    sections: [
      {
        paragraphs: [
  ...
  "tiff-and-png-for-document-scans": {
    ...
    description:
      "Facturi și contracte: stocare fără pierderi, multipagină și când PDF e suficient.",
    sections: [
      {
        paragraphs: [
  ...
  "markdown-to-pdf-workflow": {
    ...
    description:
      "MD → HTML → PDF/DOCX: când exportul din editor e suficient și când ajută un convertor online.",
    sections: [
      {
        paragraphs: [
  ...
  "extract-images-from-pdf-pages": {
    ...
    description:
      "Slide-uri, cataloage și scanări — când exportul unei pagini ca imagine are sens și ce rezoluție.",
    sections: [
      {
        paragraphs: [
  ...
  "convert-video-to-gif-properly": {
    ...
    description:
      "MP4/MOV în GIF fără fișier uriaș: limite practice și alternative.",
    sections: [
      {
        paragraphs: [
  ...
  "split-pdf-pages-guide": {
    ...
    description:
      "Când împarți PDF-uri, cum alegi intervale de pagini și ce faci cu rezultatul ZIP.",
    sections: [
      {
        paragraphs: [
  ...
  "remove-exif-privacy-guide": {
    ...
    description:
      "GPS, model cameră și date în metadata EXIF — riscuri de confidențialitate și eliminare.",
    sections: [
      {
        paragraphs: [
  ...
  "jwt-decode-safely-guide": {
    ...
    description:
      "Header, payload și Base64URL — când decodezi local și ce să nu faci.",
    sections: [
      {
        paragraphs: [
  ...
  "mortgage-loan-calculator-guide": {
    ...
    description:
      "Anuitate, comisioane și asigurări — cum citești rezultatul unui calculator ipotecar.",
    sections: [
      {
        paragraphs: [
