/**
 * One-off generator: builds residual-locale-fixes-data.json from still-en patches.
 * Run: node scripts/generate-residual-fixes-data.mjs
 */
...
/** Native fixes keyed by locale — every still-en leaf gets a non-EN value (except brands/URLs). */
const FIXES = {
  ar: {
  ...
  cs: {
    ...
    nav: { downloader: "MP3 stahovač", premium: "Premium", faq: "FAQ" },
    recommender: { categories: { video: "Video" } },
    opener: { kindVideo: "Video", kinds: { video: "Video" } },
    footer: { faq: "FAQ", facebook: "Facebook", instagram: "Instagram", messenger: "Messenger", youtube: "YouTube" },
  ...
  da: {
    ...
    nav: { downloader: "MP3-henter", premium: "Premium", faq: "FAQ" },
  ...
  el: {
    ...
    nav: { downloader: "Λήψη MP3", premium: "Premium", faq: "FAQ" },
    ai: { badge: "Premium AI" },
    footer: { faq: "FAQ", facebook: "Facebook", instagram: "Instagram", messenger: "Messenger", youtube: "YouTube" },
    cookieConsent: { title: "Cookies" },
    account: { premiumBadge: "Premium" },
    ...
    nav: { downloader: "MP3-lataaja", premium: "Premium", faq: "FAQ" },
    recommender: { categories: { video: "Video" } },
    opener: { kindVideo: "Video", kinds: { video: "Video" } },
    footer: { faq: "FAQ", facebook: "Facebook", instagram: "Instagram", messenger: "Messenger", youtube: "YouTube" },
    account: { premiumBadge: "Premium" },
  ...
  hi: {
    ...
    nav: { downloader: "MP3 डाउनलोडर", premium: "Premium", faq: "FAQ" },
    footer: { faq: "FAQ", facebook: "Facebook", instagram: "Instagram", messenger: "Messenger", youtube: "YouTube" },
    account: { premiumBadge: "Premium" },
    downloader: {
      eyebrow: "वीडियो → MP3",
  ...
  id: {
    ...
    nav: { downloader: "Pengunduh MP3", premium: "Premium", faq: "FAQ" },
    recommender: { categories: { video: "Video" } },
    ...
    pages: { editorial: { eyebrow: "Editorial" }, terms: { s2PremiumTerm: "Premium" } },
  },
  it: {
    premiumPage: { title: "Toolando Premium", premiumTitle: "Premium", supporterTitle: "Supporter" },
    privacyPage: { badge: "Privacy al primo posto" },
    nav: { downloader: "Scaricatore MP3", premium: "Premium", faq: "FAQ" },
    feedback: { no: "No" },
    recommender: { categories: { video: "Video" } },
    opener: { kindVideo: "Video", kindAudio: "Audio", kinds: { video: "Video", audio: "Audio" } },
    footer: { faq: "FAQ", facebook: "Facebook", instagram: "Instagram", messenger: "Messenger", youtube: "YouTube" },
  ...
  ja: {
    ...
    nav: { downloader: "MP3ダウンローダー", premium: "Premium", faq: "FAQ" },
    footer: { faq: "FAQ", facebook: "Facebook", instagram: "Instagram", messenger: "Messenger", youtube: "YouTube" },
    account: { premiumBadge: "Premium" },
    downloader: {
      eyebrow: "動画 → MP3",
  ...
  ko: {
    ...
    nav: { downloader: "MP3 다운로더", premium: "Premium", faq: "FAQ" },
    footer: { faq: "FAQ", facebook: "Facebook", instagram: "Instagram", messenger: "Messenger", youtube: "YouTube" },
    account: { premiumBadge: "Premium" },
    downloader: {
      eyebrow: "동영상 → MP3",
    ...
    pages: { faq: { eyebrow: "FAQ" }, terms: { s2PremiumTerm: "Premium" } },
  },
  nl: {
  ...
  no: {
    ...
    nav: { downloader: "MP3-nedlaster", premium: "Premium", faq: "FAQ" },
    recommender: { categories: { video: "Video" } },
    opener: { kindVideo: "Video", kinds: { video: "Video" } },
    footer: { faq: "FAQ", facebook: "Facebook", instagram: "Instagram", messenger: "Messenger", youtube: "YouTube" },
  ...
  pt: {
    ...
    nav: { downloader: "Descarregador MP3", premium: "Premium", faq: "FAQ" },
    footer: {
      faq: "FAQ",
      editorial: "Editorial",
      facebook: "Facebook",
  ...
  ro: {
    ...
    nav: { contact: "Contact", downloader: "Descărcător MP3", premium: "Premium", faq: "FAQ" },
    ...
    downloader: {
      eyebrow: "Video → MP3",
      title: "Descărcător Multi-Platform → MP3",
      inputPlaceholder: "https://www.tiktok.com/@user/video/...",
      idLabel: "ID",
    },
    pages: {
  ...
  ru: {
    ...
    nav: { downloader: "MP3-загрузчик", premium: "Premium", faq: "FAQ" },
    footer: { faq: "FAQ", facebook: "Facebook", instagram: "Instagram", messenger: "Messenger", youtube: "YouTube" },
    account: { premiumBadge: "Premium" },
    downloader: {
  ...
  sv: {
    ...
    nav: { downloader: "MP3-nedladdare", premium: "Premium", faq: "FAQ" },
    recommender: { categories: { video: "Video" } },
    opener: { kindVideo: "Video", kinds: { video: "Video" } },
    footer: { faq: "FAQ", facebook: "Facebook", instagram: "Instagram", messenger: "Messenger", youtube: "YouTube" },
    tool: { maxSize: "max. 500 MB" },
...
const stillEnFiles = fs.readdirSync(STILL_EN_DIR).filter((f) => f.endsWith(".json"))
let totalKeys = 0
const perLocale = {}
...
for (const file of stillEnFiles) {
  ...
  if (stillLeaves.length !== fixLeaves.length) {
    console.error(
      `${locale}: still-en has ${stillLeaves.length} keys, FIXES has ${fixLeaves.length}`
    )
  ...
  for (const { path: p, value: stillVal } of stillLeaves) {
    const fixVal = getByPath(fix, p)
    const enVal = getByPath(EN, p)
    if (fixVal === undefined) {
      console.error(`${locale}.${p}: missing fix value`)
      process.exit(1)
    }
    if (fixVal === stillVal && fixVal === enVal && !ALLOW_IDENTICAL.has(String(fixVal))) {
      console.warn(`${locale}.${p}: fix still identical to EN: "${fixVal}"`)
    }
  }
...
const outPath = path.join(__dirname, "residual-locale-fixes-data.json")
